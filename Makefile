...
# addons.rh-ecosystem-edge.io/nvidia-gpu-addon-operator-bundle:$VERSION and addons.rh-ecosystem-edge.io/nvidia-gpu-addon-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= addons.rh-ecosystem-edge.io/nvidia-gpu-addon-operator
...
envtest: ## Download envtest-setup locally if necessary.
	@GOBIN=$(PROJECT_DIR)/bin GO111MODULE=on go install sigs.k8s.io/controller-runtime/tools/setup-envtest@latest
